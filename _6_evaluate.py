...
# lưu file classification_report.txt
...
if __name__ == "__main__":
    ...
    config = json.load(open('_0_config.json', 'r'))
    ...
    model = load_model(os.path.join(config['checkpoint_filepath'], 'saved_model_with_aug.keras'))
    model.summary()
